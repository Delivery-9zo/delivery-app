...
public class OrderService {
    ...
    @Transactional
    public OrderToCanceledResponseDto updateOrderStateToCancel(UUID orderId, OrderToCanceledRequestDto orderToCanceledRequestDto, User user) {
        ...
        try {
            ...
            } else if (!orderToCanceledRequestDto.getOrderState().equals(OrderState.WAIT)) {
            ...
            LocalDateTime orderTimeFiveMinutesLater = orderToCanceledRequestDto.getOrderTime().plusMinutes(5);
